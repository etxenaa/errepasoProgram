...
public class logelak {
    ...
    public logelak(int i, String iz, String z, int ih, boolean o) {
        this.id = i;
        this.izena = iz;
        this.zerbitzuak = z;
        this.id_hotel = ih;
    ...
    public int hashCode() {
        ...
        result = prime * result + (okupatuta ? 1231 : 1237);
    ...
    public void irakurri(Scanner sc) {
        ...
        System.out.println("Logela okupatuta dago? True/False");
        this.okupatuta = sc.nextBoolean();
